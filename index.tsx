...
const App = () => {
  ...
  return (
    <>
      <audio ref={audioRef} loop src="https://music.163.com/song/media/outer/url?id=2124385.mp3" />
      <div id="ui-layer">
        {!started ? (
            <div className="landing-overlay">
                <div className="landing-card">
                    ...
                    <label className="checkbox-container">
                        <input 
                            type="checkbox" 
                            checked={hideCameraPreview} 
                            onChange={(e) => setHideCameraPreview(e.target.checked)} 
                        />
                        <span className="checkmark"></span>
                        <span className="checkbox-text">隐藏摄像头画面 (后台识别)</span>
                    </label>
                    ...
                    <label className="checkbox-container">
                        ...
                        />
                        <span className="checkmark"></span>
                        <span className="checkbox-text">全屏沉浸体验</span>
                    </label>
      ...
      <video 
        ref={videoRef} 
        id="webcam-preview" 
        className={`${started ? 'active' : ''} ${hideCameraPreview ? 'hidden' : ''}`} 
        playsInline 
        muted
      ></video>
